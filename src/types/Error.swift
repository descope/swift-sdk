...
extension DescopeError {
    public static let networkError = DescopeError(code: "S010001")
    ...
    // internal
    static let serverError = DescopeError(code: "S010002")
    static let decodeError = DescopeError(code: "S010003")
    static let encodeError = DescopeError(code: "S010004")
    static let tokenError = DescopeError(code: "S010005")
}
